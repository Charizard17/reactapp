...
class UpdateUser extends Component {
    ...
    componentDidMount = async () => {
        ...
        const response = await axios.get(`http://localhost:3007/users/${id}`);
    ...
    updateUser = async (dispatch,e) => {
        ...
        const response = await axios.put(`http://localhost:3007/users/${id}`,updatedUser);
